...
public class ModelHatTan<T extends WeatherSkeletonEntity> extends WeatherSkeletonModel<T>
{
    public ModelHatTan()
    {
        textureWidth = 244;
        ...
        hat.cubeList.add(new ModelBox(hat, 210, 19, -5.0F, -6.0F, -4.0F, 1, 1, 9, 0.0F, false));
        hat.cubeList.add(new ModelBox(hat, 208, 19, -6.0F, -6.0F, -2.0F, 1, 1, 6, 0.0F, false));
        hat.cubeList.add(new ModelBox(hat, 208, 32, -4.0F, -6.0F, -5.0F, 8, 1, 1, 0.0F, false));
        hat.cubeList.add(new ModelBox(hat, 214, 23, -2.0F, -6.0F, -7.0F, 4, 1, 1, 0.0F, false));
        hat.cubeList.add(new ModelBox(hat, 208, 19, 5.0F, -6.0F, -2.0F, 1, 1, 6, 0.0F, false));
        hat.cubeList.add(new ModelBox(hat, 208, 19, 4.0F, -6.0F, -4.0F, 1, 1, 9, 0.0F, false));
        ...
        hat.cubeList.add(new ModelBox(hat, 212, 19, 3.0F, -9.0F, -2.0F, 1, 1, 5, 0.0F, false));
        hat.cubeList.add(new ModelBox(hat, 212, 20, 3.0F, -8.0F, -2.0F, 1, 1, 5, 0.0F, false));
        ...
        hat.cubeList.add(new ModelBox(hat, 214, 19, -4.0F, -8.0F, -2.0F, 1, 1, 5, 0.0F, false));
        hat.cubeList.add(new ModelBox(hat, 217, 22, -4.0F, -8.0F, -4.0F, 1, 1, 2, 0.0F, false));
        hat.cubeList.add(new ModelBox(hat, 213, 20, -3.0F, -8.0F, -5.0F, 6, 1, 1, 0.0F, false));
        hat.cubeList.add(new ModelBox(hat, 218, 23, 3.0F, -8.0F, -4.0F, 1, 1, 2, 0.0F, false));
        ...
        hat.cubeList.add(new ModelBox(hat, 214, 19, -4.0F, -9.0F, -2.0F, 1, 1, 5, 0.0F, false));
        hat.cubeList.add(new ModelBox(hat, 207, 17, -3.0F, -9.0F, -4.0F, 6, 1, 8, 0.0F, false));
        hat.cubeList.add(new ModelBox(hat, 208, 32, -3.0F, -6.0F, -6.0F, 6, 1, 1, 0.0F, false));
    }
