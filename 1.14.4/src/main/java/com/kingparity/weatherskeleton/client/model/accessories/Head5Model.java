...
public class Head5Model<T extends WeatherSkeletonEntity> extends WeatherSkeletonModel<T>
{
    public Head5Model()
    {
        textureWidth = 244;
        ...
        head.cubeList.add(new ModelBox(head, 171, 53, -2.0F, -2.0F, -7.0F, 1, 1, 1, 0.0F, false));
    }
