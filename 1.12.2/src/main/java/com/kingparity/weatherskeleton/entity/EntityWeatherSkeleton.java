...
import com.kingparity.weatherskeleton.init.WeatherItems;
import com.kingparity.weatherskeleton.init.WeatherLootTables;
import com.kingparity.weatherskeleton.init.WeatherSounds;
import com.kingparity.weatherskeleton.network.MessageWeatherSkeleton;
...
public class EntityWeatherSkeleton extends EntityCreature
{
    ...
    public void onLivingUpdate()
    {
        ...
        if(world.getClosestPlayerToEntity(this, 5) != null)
        {
            if(flag == false)
            {
                if(!world.isRemote)
